...
const translations: { [key in Language]: Translations } = {
  bn: {
    ...
    notifDeviceSold: 'ডিভাইস বিক্রি হয়েছে',
    notifWelcome: 'স্বাগতম',
    notifLogin: 'লগইন সফল',
    notifCommission: 'কমিশন পেয়েছেন',
    notifReferral: 'নতুন রেফারেল',
    notifWithdrawal: 'উত্তোলন',
    notifTransfer: 'ট্রান্সফার',
    notifBoughtDevice: 'আপনার ডিভাইস কিনেছে',
    notifWelcomeMsg: 'FonCloud এ স্বাগতম! আপনার যাত্রা শুরু হয়েছে।',
    notifLoginMsg: 'আপনি সফলভাবে লগইন করেছেন।',
    notifCommissionMsg: 'রেফারেল থেকে কমিশন জমা হয়েছে',
    notifReferralMsg: 'আপনার রেফারেল কোড ব্যবহার করে যোগ দিয়েছে',
    notifWithdrawalMsg: 'উত্তোলনের অনুরোধ প্রক্রিয়াধীন',
    notifTransferMsg: 'ট্রান্সফার সম্পন্ন হয়েছে',
  ...
  en: {
    ...
    notifDeviceSold: 'Device Sold',
    notifWelcome: 'Welcome',
    notifLogin: 'Login Successful',
    notifCommission: 'Commission Received',
    notifReferral: 'New Referral',
    notifWithdrawal: 'Withdrawal',
    notifTransfer: 'Transfer',
    notifBoughtDevice: 'bought your device',
    notifWelcomeMsg: 'Welcome to FonCloud! Your journey begins now.',
    notifLoginMsg: 'You have successfully logged in.',
    notifCommissionMsg: 'Commission credited from referral',
    notifReferralMsg: 'joined using your referral code',
    notifWithdrawalMsg: 'Withdrawal request is being processed',
    notifTransferMsg: 'Transfer completed successfully',
